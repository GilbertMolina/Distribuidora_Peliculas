...
Public Class rptPremiosPorPelicula
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPremiosPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptPremiosPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPremiosPorPelicula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPremiosPorPelicula = New rptPremiosPorPelicula()
        rpt.Site = Me.Site
        Return rpt
    End Function
