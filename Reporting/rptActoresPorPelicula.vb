...
Public Class rptActoresPorPelicula
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptActoresPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptActoresPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActoresPorPelicula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActoresPorPelicula = New rptActoresPorPelicula()
        rpt.Site = Me.Site
        Return rpt
    End Function
