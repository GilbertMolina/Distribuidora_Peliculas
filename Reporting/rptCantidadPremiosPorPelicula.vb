...
Public Class rptCantidadPremiosPorPelicula
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCantidadPremiosPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptCantidadPremiosPorPelicula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCantidadPremiosPorPelicula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCantidadPremiosPorPelicula = New rptCantidadPremiosPorPelicula()
        rpt.Site = Me.Site
        Return rpt
    End Function
