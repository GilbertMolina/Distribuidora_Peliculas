...
Public Class rptCriticasPorActor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCriticasPorActor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptCriticasPorActor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCriticasPorActor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCriticasPorActor = New rptCriticasPorActor()
        rpt.Site = Me.Site
        Return rpt
    End Function
